Задача 1.1 - коммит init commit (task 1), файлы: dags/insert_data_task1.py, sql/create_schemas.sql, sql/create_ds_tables.sql, sql/create_log_table.sql
 
Задача 1.2 - коммит add task 2 fill dm, файлы: dags/fill_dm_task2.py, sql/create_showcase.sql, sql/insert_balance.sql, sql/fill_account_turnover_f.sql, sql/fill_account_balance_f.sql

Задача 1.3 - коммит fill 101 form task3, файлы: dags/fill_101_form_task3.py, sql/create_f101_table.sql, sql/fill_f101_round_f.sql

Задача 1.4 - коммит export and import 101 form task 4, файлы: dags/import_f101_from_csv_task4.py, dags/export_f101_to_csv_task4.py, sql/create_f101_v2.sql, sql/export_f101.sql
...
Ссылка на текстовый файл (с примерным содержанием видео):

https://docs.google.com/document/d/18lwqi14Gs3yZ_1Zpb30Qw41g1wUvRFrhMuiHjQimLPA/edit?usp=drive_link
...
https://disk.yandex.ru/i/pgSJrwaLRk-9dA

Ссылка на текстовый файл (с примерным содержанием видео):

https://docs.google.com/document/d/1o4EIgb5yekGwSvbXTNEVAbizQ3RIXwiglXWHh1NuTTo/edit?usp=drive_link
...
Ссылка на текстовый файл со скриншотами работы запроса:

https://docs.google.com/document/d/1XemRfEM7Y1nZnGQ-C7RCuwWM8jkT2AuhmWIvYdvSbT0/edit?usp=drive_link


Задание 2.2

Коммит - task2.2, файлы - dags/load_data_task_2_2.py, sql/analysis_dm_loan_holiday_info.sql, sql/analisys_product.sql, sql/analysis_deal_info.sql, sql/analysis_loan_holiday.sql, sql/fill_loan_holiday_info.sql, sql/analisys_loan_holiday_rows.sql, sql/analisys_product_rows.sql
